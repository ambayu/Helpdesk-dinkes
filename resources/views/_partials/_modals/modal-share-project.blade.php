        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body pt-3 pt-md-0">
                ...
                <div class="text-center">
                    <h3 class="mb-2">Daftarkan Petugas Yang Mengurus</h3>
                    <p>Daftarkan petugas yang mengurus permintaan</p>
                </div>
            </div>
            <div class="col-12 mb-4 pb-2">
                <div class="form-floating form-floating-outline">
                    <select id="select2Basic" class="form-select form-select-lg share-project-select"
                        ...
                        <option data-name="Julian Murphy" data-image="img/avatars/9.png" selected>Pilih Petugas Layanan
                        </option>

                        <option data-name="Adelaide Nichols" data-image="img/avatars/20.png">Adelaide Nichols
                        </option>
                ...
                <li class="d-flex mb-3 flex-wrap">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                            ...
                            <p class="mb-0">pe@vogeiz.net</p>
                        </div>
                        <div class="dropdown">
                            <button type="button" class="btn btn-text-secondary dropdown-toggle p-2"
                                data-bs-toggle="dropdown" aria-expanded="false"><span
                                    class="me-2 d-none d-sm-inline-block">Can Edit</span></button>
                ...
                <li class="d-flex mb-3 flex-wrap">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                            ...
                            <p class="mb-0">ha@sugit.gov</p>
                        </div>
                        <div class="dropdown">
                            <button type="button" class="btn btn-text-secondary dropdown-toggle p-2"
                                data-bs-toggle="dropdown" aria-expanded="false"><span
                                    class="me-2 d-none d-sm-inline-block">Can View</span> </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);">Owner</a>
                                </li>
            ...
            <div class="d-flex align-items-start mt-4 align-items-sm-center">
                ...
                <div class="d-flex justify-content-between flex-grow-1 align-items-center flex-wrap gap-2">
                    <h6 class="mb-0">Public to {{ config('variables.templateName') }} -
                        {{ config('variables.creatorName') }}</h6>
